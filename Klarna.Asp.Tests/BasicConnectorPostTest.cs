...
namespace Klarna.Asp.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public class BasicConnectorPostTest
    {
        ...
        /// <summary>
        /// Runs the ASP unit tests for BasicConnector class.
        /// </summary>
        [Test]
        public void BasicConnectorPostTests()
        {
            var runner = Runner.Create(AspTestUrl)
                .WithEncoding(Encoding.UTF8).WithTestContainer("BasicConnectorPostTest");
