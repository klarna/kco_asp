...
Class UserAgentTest
    ...
    Public Sub Creation(testResult)
        Call testResult.AssertEquals("Library/Klarna.ApiWrapper_1.0.2 Language/ASP_Classic", _
    ...
    Public Sub AddFieldWithoutOptions(testResult)
        ...
        Call testResult.AssertEquals("Library/Klarna.ApiWrapper_1.0.2 Language/ASP_Classic JS Lib/jQuery_1.8.2", _
                                        ua.ToString, "The UA string")
    End Sub
    ...
    Public Sub AddFieldWithOptions(testResult)
        ...
        Call testResult.AssertEquals("Library/Klarna.ApiWrapper_1.0.2 Language/ASP_Classic Module/Magento_5.0, LanguagePack/7;JsLib/2.0", _
                                        ua.ToString, "The UA string")
    End Sub
