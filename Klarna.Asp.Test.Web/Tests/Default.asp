...
<!-- #include file="ApiErrorTest.asp" -->
<!-- #include file="DigestTest.asp" -->
<!-- #include file="OrderTest.asp" -->
<!-- #include file="RecurringStatusTest.asp" -->
<!-- #include file="RecurringOrderTest.asp" -->
...
Call runner.AddTestContainer(New RecurringStatusTest)
Call runner.AddTestContainer(New RecurringOrderTest)
...
Call runner.AddTestContainer(New ApiErrorTest)
